...
# This fixture needs the client to register and login the user first
# Scope changed from "module" to "function" to match async_client scope
@pytest_asyncio.fixture(scope="function")
async def user_and_token(async_client: AsyncClient, test_db): # Added test_db fixture for cleanup
