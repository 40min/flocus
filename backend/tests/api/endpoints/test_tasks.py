...
async def test_create_task_success(
    ...
    assert created_task.statistics.lasts_minutes == 0
...
async def test_update_task_statistics_flow_via_api(
    ...
    assert updated_task_1.statistics.lasts_minutes == 0
    ...
    assert updated_task_2.statistics.lasts_minutes == 30  # (mock_time_2 - mock_time_1) / 60
    ...
    assert updated_task_3.statistics.lasts_minutes == 30  # Unchanged until next stop
    ...
    assert updated_task_4.statistics.lasts_minutes == (30 + 10)  # 30 (previous) + 10 (mock_time_4 - mock_time_3)
...
async def test_update_task_no_status_change_no_stat_change_via_api(
    ...
    task_in_db.statistics.lasts_minutes = initial_lasts_min
    ...
    assert updated_task.statistics.lasts_minutes == initial_lasts_min
