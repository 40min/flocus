...
describe("CategoriesPage", () => {
  ...
  it("opens, fills, and submits the create category modal successfully", async () => {
    ...
    expect(
      screen.queryByRole("dialog", { name: /create new category/i })
  ...
  it("displays API error message on create category failure", async () => {
    ...
    await waitFor(() => {
      expect(
        within(modal).getByText("Category name already exists")
      ).toBeInTheDocument();
    });
  ...
  it("displays an error in the modal on update category failure", async () => {
    ...
    await waitFor(() => {
      expect(
        within(modal).getByText("Failed to update category.")
      ).toBeInTheDocument();
    });
