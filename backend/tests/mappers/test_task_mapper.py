...
def sample_task_model(
    ...
    return Task(
        ...
        statistics=TaskStatistics(
            lasts_minutes=15, was_started_at=now - timedelta(minutes=30), was_taken_at=now - timedelta(minutes=15)
        ),
    )
...
class TestTaskMapper:
    ...
    def test_to_response_with_category(
        ...
        assert task_response.statistics.lasts_minutes == sample_task_model.statistics.lasts_minutes
    ...
    def test_to_response_without_category(self, sample_task_model: Task):
        ...
        assert task_response.statistics.lasts_minutes == task_model_no_category.statistics.lasts_minutes
